...
int main(int argc,char* argv[]){
    ...
    if(argc==1){//默认启动，仅供测试
        register_centre.init("11111","11112","0.0.0.0","IN6ADDR_ANY");
        ok6=1;
        goto defaultstart;
    }
    ...
    while(1){
        ...
        if(command=="help"){
            ...
            register_centre.showself(1,ok6);
        }
